* Score-based Web Filter
A content filter for websites, emulating dansguardian's score-based filter.
* Deployed at
  - Firefox: https://addons.mozilla.org/en-US/firefox/addon/web-site-filter/, and
  - Google Chrome: https://chrome.google.com/webstore/detail/score-based-web-filter/ojofglimbmclnbinpbjnhcmkmipplibi/
* Versions
** 0.6.2
*** Added
